...
namespace ConsoleApp1.ManipulaçãoDeArrays
{
    internal class Program
    {
        static void Main(string[] args)
        {
            int[] sequenciaNumeros = new int[] //como array faz tudo isso sem fazer contas/simbolos 
            {
            ...
            decimal valorMedio = CalcularMedia(sequenciaNumeros); //como ele calculou a média?

            int[] maioresNumeros = EncontrarMaioresNumeros(sequenciaNumeros);   //como ele encontou o maior número?

            int[] numerosNegativos = EncontrarNumerosNegativos(sequenciaNumeros); // como ele encontrou o menor número 
            ...
            MostrarNaTela("Os três maiores números são: " + string.Join("; ", maioresNumeros)); //como?

            MostrarNaTela("Os números negativos são: " + string.Join("; ", numerosNegativos));//como?
